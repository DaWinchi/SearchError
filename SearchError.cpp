...
// SearchError.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSearchErrorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CSearchErrorApp

CSearchErrorApp::CSearchErrorApp()
{
...
// Единственный объект CSearchErrorApp

CSearchErrorApp theApp;


// инициализация CSearchErrorApp

BOOL CSearchErrorApp::InitInstance()
{
